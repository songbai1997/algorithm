...
如果 len - next[len] == len 说明整个字符串是一个循环节，需要特判一下。当然这个求的最小循环节，次小的循环节应该是 len - next[next[len]]，以此类推，当然需要判断一下啦。

参考博客：[https://blog.csgrandeur.com/2021-04-27-try-to-prove-loop-by-kmp/](https://blog.csgrandeur.com/2021-04-27-try-to-prove-loop-by-kmp/)
